...
Full-stack AI-powered study assistant with chat, document understanding, flashcards, quizzes, and progress tracking. Inspired by the YouTube build video: [Build a Full-Stack AI-Powered Learning Assistant App | MERN, React, Node.js, MongoDB, Express]
